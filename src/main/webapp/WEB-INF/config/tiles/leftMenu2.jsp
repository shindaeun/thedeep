...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
        ...
        <div data-collapse="medium" data-animation="default" data-duration="400" class="w-nav">
          <div class="container-8 w-container">
            ...
            <a href="/adminList.do" class="nav-link-18 w-nav-link">회원관리</a>
            <a href="/orderList.do" class="nav-link-18 w-nav-link">주문관리</a>
            <a href="/productListView.do" class="nav-link-18 w-nav-link">상품관리</a>
            <a href="/group.do" class="nav-link-18 w-nav-link">상품그룹관리</a>
            <a href="/adminBoard.do" class="nav-link-18 w-nav-link">게시판관리</a>
            <a href="/adminNoticeList.do" class="nav-link-18 w-nav-link">공지사항</a>
            <br>
