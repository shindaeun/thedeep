...
$(function(){
	...
	$("#btnSearch1").click(function(){
		...
		$("#form1").attr({method:'post',action:'/userBoard.do'}).submit();
	});
	$("#btnSearch2").click(function(){
		...
		$("#form2").attr({method:'post',action:'/userBoard.do'}).submit();
	});
	...
	<table>
		<tr>
			<td><select name="searchCondition">
					...
					<button type="button" id="btnSearch1" class="white">검색</button>
				</td>
		</tr>
	</table>
</form>
				...
				<tr>
					<td style="border: 0px; text-align: center">
        				...
        				<c:forEach var="i" begin="${ start}" end="${last }">
        					...
        					<a href="/userBoard.do?pageIndex=${i}&${parm1}&${ parm2}">${i}</a></c:if>
        				</c:forEach>
				...
				<tr>
					<td style="border: 0px; text-align: center">
        				...
        				<c:forEach var="i" begin="${ start}" end="${last }">
        					...
        					<a href="/userBoard.do?pageIndex2=${i}&${parm1}&${ parm2}">${i}</a></c:if>
        				</c:forEach>
